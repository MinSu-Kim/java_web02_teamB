...
public class PanelSaleList extends JPanel implements DocumentListener, ActionListener, ItemListener {
   ...
   private JButton btnSelectByToday;
   /*
   ...
   private void initComponents() {
      ...
      btnSelectByToday = new JButton("오늘날짜보기");
      btnSelectByToday.addActionListener(this);
   ...
   public void actionPerformed(ActionEvent e) { // 결제취소
      if (e.getSource() == btnSelectByToday) {
         actionPerformedBtnSelectByToday(e);
      }
   ...
   public void setListToday() {
      ...
      itemList = service.selectPaymentByDate(format.format(now));
      pList.setItemList(itemList);
      pList.reloadData();
   ...
   private void actionPerformedBtnSelectByToday(ActionEvent e) {
      setDatePickerText();
      setListToday();
      setCmbClear();
      panel_4.setpList(itemList);
